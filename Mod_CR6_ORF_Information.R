...
PopulateModCR6CodonClasses <- function(orfFile, orfName, orfStart, orfEnd) {
...
orf1CodonClassList <- PopulateModCR6CodonClasses(orfFile = "./Mod_CR6_ORFs/Mod_CR6_ORF1_nt.txt",
                                                 orfName = "ORF1",
...
orf2CodonClassList <- PopulateModCR6CodonClasses(orfFile = "./Mod_CR6_ORFs/Mod_CR6_ORF2_nt.txt",
                                                 orfName = "ORF2",
...
orf3CodonClassList <- PopulateModCR6CodonClasses(orfFile = "./Mod_CR6_ORFs/Mod_CR6_ORF3_nt.txt",
                                                 orfName = "ORF3",
...
fullGenome <- readr::read_file("./data/Mod_CR6_ORFs/Mod_CR6_FullGenome.txt")
fullGenomeNoBreaks <- str_remove_all(fullGenome, pattern = "\\n")
ORF4 <- base::substr(fullGenomeNoBreaks, start = 5069, stop = 5707)
# save
write(ORF4, ".data/Mod_CR6_ORFs/Mod_CR6_ORF4_nt.txt", sep = "\t")
# Make class list and LUT
orf4CodonClassList <- PopulateCodonClasses(orfFile = "./data/Mod_CR6_ORFs/Mod_CR6_ORF4_nt.txt",
                                           orfName = "ORF4",
